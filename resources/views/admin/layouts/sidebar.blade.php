...
<nav>
    ...
    <li><a href="{{ route('admin.products.index') }}" class="{{ request()->routeIs('products.*') ? 'active' : '' }} sidebar-menu-main"><span class="sidebar-icon"><img src="{{ asset('images/products.png') }}" alt="Products" ></span> Products</a></li>
    <li><a href="{{ route('admin.categories.index') }}" class="{{ request()->routeIs('categories.*') ? 'active' : '' }} sidebar-menu-main"><span class="sidebar-icon"><img src="{{ asset('images/categories.png') }}" alt="Categories" ></span> Categories</a></li>
    <li><a href="{{ route('admin.collections.index') }}" class="{{ request()->routeIs('collections.*') ? 'active' : '' }} sidebar-menu-main"><span class="sidebar-icon"><img src="{{ asset('images/collections.png') }}" alt="Collections" ></span> Collections</a></li>

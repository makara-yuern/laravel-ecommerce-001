...
<nav>
    ...
    <li><a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'active' : '' }} sidebar-menu-main"><span class="sidebar-icon"><img src="{{ asset('images/home.png') }}" alt="Home" ></span> Dashboard</a></li>
    ...
    <li><a href="{{ route('profile') }}" class="{{ request()->routeIs('profile') ? 'active' : '' }} sidebar-menu-main"><span class="sidebar-icon"><img src="{{ asset('images/profile.png') }}" alt="Profile" ></span> Profile</a></li>
    </ul>
</nav>
